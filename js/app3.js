...
let cardA =0;  //SideA of the card selected
let cardB =0;  //SideB of the card selected
      ...
      let number = prompt("Enter number of players from 2 to 4")
       ...
       // alert("" + a + b); //Converts to a string
        ...
        if (max1 > max2) {
          ...
          let doubleCard = max1 + str
          document.getElementById("highCard").innerHTML = "Player 1 plays first with: " + doubleCard;
          ...
          let doubleCard = max2 + str
          document.getElementById("highCard").innerHTML = "Player 2 plays first with: " + doubleCard;
          p2Turn = true;
